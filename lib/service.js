    ...
    async #addUpstream ( upstream ) {
        ...
        if ( this.#isHttpEnabled ) {
            ...
            if ( res.ok ) {
                ...
                this.#log( `failed to add http upstream`, `${upstream}:80`, res + "" );
            }
        }
        ...
        if ( this.#isStreamEnabled ) {
            for ( const port of this.#streamPort ) {
                ...
                if ( res.ok ) {
                    ...
                    this.#log( `failed to add stream upstream`, `${upstream}:${port}`, res + "" );
                }
            }
        }
    }
    ...
    async #removeUpstream ( upstream ) {
        ...
        if ( this.#isHttpEnabled ) {
            ...
            if ( res.ok ) {
                ...
                this.#log( `failed to remove http upstream`, `${upstream}:80`, res + "" );
            }
        }
        ...
        if ( this.#isStreamEnabled ) {
            for ( const port of this.#streamPort ) {
                ...
                if ( res.ok ) {
                    ...
                    this.#log( `failed to remove stream upstream`, `${upstream}:${port}`, res + "" );
                }
            }
        }
    }
