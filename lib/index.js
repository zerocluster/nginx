...
module.exports = class Nginx {
    ...
    static installLoadBalancerConfig ( id, upstreamHost, upstreamPort, serverName ) {

        // init
        init();

        const conf = ejs.render( fs.readFileSync( __dirname + "/../resources/tmpl/nginx/vhost.nginx.conf", "utf8" ), {
            id,
