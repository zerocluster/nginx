...
module.exports = class Nginx {
    ...
    async run () {
        ...
        for ( const service of services ) {
            await this.#addService( new Service( service.ID, { "name": service.Spec.Name, "nginxServerName": service.Spec.Labels[SERVER_NAME_LABEL] } ) );
        }
    ...
    async #addService ( service ) {
        ...
        const conf = ejs.render( fs.readFileSync( __dirname + "/../resources/tmpl/vhost.nginx.conf", "utf8" ), {
            ...
            "server_name": await service.getNginxServerName(),
            "cache_dir": CACHE_DIR,
