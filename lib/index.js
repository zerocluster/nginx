...
module.exports = class {
    ...
    run () {
        ...
        // deploy default vhost, if not exists
        if ( !fs.existsSync( VHOSTS_DIR + "/_default.nginx.conf" ) ) fs.copyFileSync( __dirname + "/../resources/tmpl/vhost-default.nginx.conf", VHOSTS_DIR + "/_default.nginx.conf" );
