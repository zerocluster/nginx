...
const SERVER_NAME_LABEL = process.env.SERVER_NAME_LABEL || "nginx-server-name";
...
class Service {
    ...
    async update ( options = {} ) {
        ...
        // check nginx service name changes
    ...
    async #updateService ( service ) {
        ...
        if ( this.#services[service.id] ) {
            ...
            // nginx server name label was updated
                ...
                return service.update( { "nginxServerName": service.nginxServerName } );
            }
        }
