...
export default class Nginx extends Events {
    ...
    constructor ( { location, listenIpFamily, proxyProtocol } = {} ) {
        super();
    ...
    async run () {
        ...
        const conf = ejs.render( fs.readFileSync( resolve( "#resources/templates/nginx.conf", import.meta.url ), "utf8" ), {
            ...
            "listen_ip_family": this.#listenIpFamily,
        } );
    ...
    gracefulShutdown () {
        ...
        console.log( `Nginx graceful shutdown` );
    ...
    #onProcExit ( code, signal ) {
        ...
        console.log( `Nginx process terminated, code: ${code}` );
